    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow border border-gray-200 dark:border-gray-700">
                <h2 className="text-lg font-semibold mb-3 sm:mb-4 dark:text-white">Descrição do Projeto</h2>
                <div className="overflow-hidden">
                    <p className="text-gray-700 dark:text-gray-300 whitespace-pre-line break-words overflow-wrap-anywhere">
                        {project.description}
                    </p>
                </div>
            </div>
